    ...
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-1">
          ...
          />
          {errors.username && (
            <p className="text-xs text-destructive/70">{errors.username.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1">
          ...
          {errors.confirmPassword && (
            <p className="text-xs text-destructive/70">{errors.confirmPassword.message}</p>
          )}
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground/50">
          already initiated?{" "}
          <Link href="/login" className="text-sepia hover:text-cream transition-colors">
            return
          </Link>
        </p>
      </form>
